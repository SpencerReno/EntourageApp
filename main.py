...
def show_menu():
    ...
    settings_button.place(relheight=.1,relwidth=.25, relx=.23,rely=.8)
    ...
    status_button.place(relheight=.1,relwidth=.25, relx=.52,rely=.68)
...
def change_hours_email(email_entry):
    ...
    try:
        ...
        email_entry.insert(0, str(new_email))
    except:
